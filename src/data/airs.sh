...
for file in *.png; do
    ...
    gdalwarp -ts 360 182 -t_srs "+proj=robin +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs" tmp/${file%%.png}.tif tmp/${file%%.png}_r.tif -dstnodata "252 249 243"
